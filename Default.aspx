<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="hancer.av.tr.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    <p class="animated fadeInRight">Client Focused Approach</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="image/2.jpg" alt="Carousel Image">
                <div class="carousel-caption">
                    <p class="animated fadeInRight">Effective and Perfectionist Service Approach</p>
                </div>
            </div>
            <div class="carousel-item">
    ...
    <div class="iletisim-ana" style="height: 600px; margin: 0px 15px 0px 15px; border: 3px solid #aa9166">
        <div class="harita" style="margin: 80px 30px 0px 0px; float: right">
