<%@ Page Title="" Language="C#" MasterPageFile="~/AnaSayfa.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="hancer.av.tr.index" %>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    <p class="animated fadeInRight">Müvekkil Odaklı Yaklaşım</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="image/2.jpg" alt="Carousel Image">
                <div class="carousel-caption">
                    <p class="animated fadeInRight">Etkin ve Mükemmeliyetçi Hizmet Anlayışı</p>
                </div>
            </div>
            <div class="carousel-item">
